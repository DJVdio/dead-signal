...
| 角色视觉 | 具名角色/布鲁斯 + 泛用幸存者/犬类 + 丧尸 8 套 + 袭击者 8 套八方向动作图 | OpenAI image generation + 项目内逐帧母版派生，项目原创 | 7 名具名幸存者、布鲁斯、四男四女普通丧尸、四男四女袭击者；袭击者武器/衣着与阵营/受击/血条按真实状态叠加 | 正式资源齐备；全体人类使用现实头身比，待统一实机验收 |
