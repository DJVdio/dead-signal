...
window.WIKI_BUNDLE = {
  index: {
  "generatedAt": "2026-07-22 03:34:44",
  ...
  "columns": [
    ...
    },
    {
      ...
      "label": "流血速度",
      "type": "mult",
      "configKey": "BleedRateMultiplier",
      "hint": "这一击造成的伤口流血速度乘子（1 = 标准；越大越危险，与受害者体质倍率正交相乘）。"
    },
    {
      "key": "bleedOnHit",
      "label": "命中流血几率",
    ...
    {
      "key": "stockNoiseRadius",
      "label": "枪托噪音半径(像素)",
      "type": "number",
      "configKey": "StockMeleeNoiseRadius",
      "hint": "抡枪托近战砸人的噪音半径；空 = 近战/弓弩无枪托（回落到全局默认 110）。"
    },
    {
      "key": "stockDamageType",
      "label": "枪托伤害类型",
      "type": "chip",
      "configKey": "StockMeleeDamageType",
      "valueMap": {
        "锐": "Sharp",
        "钝": "Blunt"
      },
      "hint": "枪托近战是钝击还是锐击（默认钝；装了刺刀/利爪型改装可为锐）。"
    },
    {
      "key": "structureFactor",
      "label": "砸墙倍率",
  ...
  "rows": [
    ...
    },
    {
      ...
      "stockDamageType": "钝",
      "structureFactor": 0.05,
      "description": "比人还高的长弓。它能把箭送到很远的地方。",
      "_id": "Longbow",
      "_configId": "longbow",
    ...
    },
    {
      ...
      "stockDamageType": "钝",
      "structureFactor": 0.05,
      "description": "滑轮、准星、稳定杆，一整套让人百发百中的精密玩意，它原来的主人拿它拿过奖。",
    ...
    },
    {
      ...
      "stockDamageType": "钝",
      "structureFactor": 0.05,
      "description": "单手就能端的小弩，扣下扳机跟开枪一样容易。",
      "_id": "LightCrossbow",
    ...
    },
    {
      ...
      "stockDamageType": "钝",
      "structureFactor": 0.05,
      "description": "沉重的弩，弦要用脚踩着上。它能钉穿铁皮，代价是你每分钟只能得罪一个人。",
      "_id": "HeavyCrossbow",
  ...
  "label": "护甲服装",
  "source": "src/DeadSignal.Combat/ArmorTable.cs（防护数值）+ godot/scripts/ApparelSlots.cs（穿在哪、护到哪）",
  "note": "人穿的衣服与护甲。**「穿在哪」和「护到哪」是两回事**：板甲占「装甲层 + 裤子」两个槽，护的是胸腹双臂双腿。没被护到的部位，命中时一点也不挡。手套和鞋子是**成对装备**——一件只护一只手（脚），要护全得做两件。「能力效果」来自真实穿戴目录，所有百分比与其它来源独立乘算。「腐皮」是丧尸天生的，不是能穿的衣服。",
  ...
  "rows": [
    {
      ...
      "bluntDefense": 3,
      "weight": 0.15,
      "effects": "被发现距离 -2.91%、动作噪音半径 -2.91%",
      "description": "袖子确实是长的。",
      "_id": "LongSleeveShirt",
    ...
    },
    {
      ...
      "bluntDefense": 3,
      "weight": 0.15,
      "effects": "被发现距离 -1.96%、动作噪音半径 -1.96%",
    ...
    },
    {
      ...
      "bluntDefense": 3,
      "weight": 0.25,
      "effects": "被发现距离 -3.85%、动作噪音半径 -3.85%",
      "description": "“这是我最喜欢的款式，穿上它跑得更快！”——皮特",
      "_id": "Sneakers",
      "_configId": "sneakers",
    ...
    },
    {
      ...
      "bluntDefense": 3,
      "weight": 0.1,
      "effects": "被发现距离 +2.04%、动作噪音半径 +2.04%",
      "description": "夏日风格。",
      "_id": "Shorts",
      "_configId": "shorts",
    ...
    },
    {
      ...
      "bluntDefense": 12.5,
      "weight": 4,
      "effects": "移动速度 -1%、被发现距离 +5.26%、动作噪音半径 +5.26%",
      "description": "保护你的心。",
      "_id": "ChestPlate",
    ...
    },
    {
      ...
      "bluntDefense": 3,
      "weight": 0.25,
      "effects": "被发现距离 -4.76%、动作噪音半径 -4.76%",
    ...
    },
    {
      ...
      "bluntDefense": 4,
      "weight": 0.3,
      "effects": "被发现距离 -5.66%、动作噪音半径 -5.66%",
      "description": "经典永不过时。",
      "_id": "ClothJacket",
    ...
    },
    {
      ...
      "bluntDefense": 12.5,
      "weight": 6,
      "effects": "移动速度 -3%、被发现距离 +8.7%、动作噪音半径 +8.7%",
      "description": "结实的鞣皮甲。",
      "_id": "Leather",
      "_configId": "leather",
    ...
    },
    {
      ...
      "bluntDefense": 35,
      "weight": 15,
      "effects": "移动速度 -10%、被发现距离 +53.85%、动作噪音半径 +53.85%",
    ...
    },
    {
      ...
      "bluntDefense": 14,
      "weight": 2.5,
      "effects": "被发现距离 +6.38%、动作噪音半径 +6.38%",
    ...
    },
    {
      ...
      "bluntDefense": 22,
      "weight": 4.5,
      "effects": "被发现距离 +13.64%、动作噪音半径 +13.64%",
    ...
    },
    {
      ...
      "bluntDefense": 6,
      "weight": 0.3,
      "effects": "被发现距离 +4.17%、动作噪音半径 +4.17%",
      "description": "骨片与木头缝成的脸。戴上它你不会更有勇气——但会让敌人丧失勇气。",
      "_id": "WarMask",
      "_configId": "war_mask",
    ...
    },
    {
      ...
      "bluntDefense": 1,
      "weight": 0.1,
      "effects": "被发现距离 +3.09%、动作噪音半径 +3.09%",
      "description": "直面太阳吧！",
      "_id": "Sunglasses",
    ...
    },
    {
      ...
      "bluntDefense": 1,
      "weight": 0.1,
      "effects": "阅读速度 +5%、被发现距离 +1.01%、动作噪音半径 +1.01%",
    ...
    },
    {
      ...
      "bluntDefense": 6,
      "weight": 0.1,
      "effects": "被发现距离 +5.26%、动作噪音半径 +5.26%",
    ...
    },
    {
      ...
      "bluntDefense": 3,
      "weight": 0.4,
      "effects": "被发现距离 +1.01%、动作噪音半径 +1.01%",
    ...
    },
    {
      ...
      "bluntDefense": 10,
      "weight": 5,
      "effects": "被发现距离 +21.95%、动作噪音半径 +21.95%",
  ...
  "rows": [
    ...
    },
    {
      ...
      "craftable": true,
      "weight": 0.03,
      "description": "又长又沉，被他打的猎物不会留下弹孔，只需祈祷留下完尸。",
      "_id": "ammo_long",
      "_configId": "ammo_long",
      "_anchor": "godot/scripts/Materials.cs :: Materials（名称/说明）+ src/DeadSignal.Combat/Ammo.cs :: BulletParts.YieldPer（制作比）",
      "userNote": "",
    ...
    },
    {
      ...
      "craftable": false,
      "weight": 0.03,
      "description": "碳纤维箭杆，笔直、轻盈，现代高分子材料学的得意之作。",
  ...
  "rows": [
    ...
    },
    {
      ...
      "category": "木材",
      "weight": 1,
      "description": "拆下来的断料、劈裂的板子、带钉眼的短头。单看哪一块都不成器，可你手里也没别的了。",
      "_id": "scrap_wood",
    ...
    },
    {
      ...
      "category": "化学品",
      "weight": 0.5,
      "description": "一罐熬出来的骨胶，黏、稠、气味上不了台面，但它够粘。",
      "_id": "glue",
      "_configId": "glue",
      "_anchor": "godot/scripts/Materials.cs :: Materials（重量在 godot/scripts/CarryWeight.cs :: ItemWeights）",
      "userNote": "",
    ...
    },
    {
      ...
      "category": "药材",
      "weight": 0.05,
      "description": "田埂路边遍地的野草，晒干能煮茶，也是草药膏的配料。",
      "_id": "dandelion",
      "_configId": "dandelion",
      "_anchor": "godot/scripts/Materials.cs :: Materials（重量在 godot/scripts/CarryWeight.cs :: ItemWeights）",
      "userNote": "",
    ...
    },
    {
      ...
      "category": "货币",
      "weight": 0.01,
      "description": "闪闪亮亮，末世前铸的白银，如今废土上唯一还认的硬通货。",
      "_id": "silver",
      "_configId": "silver",
      "_anchor": "godot/scripts/Materials.cs :: Materials（重量在 godot/scripts/CarryWeight.cs :: ItemWeights）",
      "userNote": "",
    ...
    },
    {
      ...
      "category": "精密零件",
      "weight": 0.05,
      "description": "弹壳、底火、弹头坯——灾前留下的精密小玩意。",
      "_id": "bullet_parts",
    ...
    },
    {
      ...
      "_configId": "damaged_sniper_rifle",
      "_anchor": "godot/scripts/Materials.cs :: Materials（重量在 godot/scripts/CarryWeight.cs :: ItemWeights）",
      "userNote": "",
      "sync": "",
      "_icon": "weapons/sniper_rifle"
  ...
  "columns": [
    ...
    },
    {
      ...
      "label": "感染几率乘子",
      "type": "mult",
      "configKey": "InfectionChanceMultiplier",
      "configRoot": "SurgerySupplies",
      "hint": "用这味手术耗材时，该处伤口感染几率要乘的倍数（1 = 不影响；草药绷带 0.75）。空 = 非手术耗材。"
    },
    {
      "key": "efficacy",
      "label": "治疗效率",
  ...
  "rows": [
    ...
    },
    {
      ...
      "_configId": "sofa",
      "_crafterGateIds": "",
      "_anchor": "godot/scripts/Recipe.cs :: RecipeBook（Id = \"sofa\"）",
      "description": "",
      "userNote": "",
      "sync": "",
      "_icon": "furniture/chair"
    ...
    },
    {
      ...
      "outputQty": 1,
      "materials": "木料*2、铁*2、绳子*1、武器零件*1",
      "tools": "卡尺",
      "craftLocation": "工作台（卡尺）",
      "books": "《机械之美》",
      "workMinutes": 180,
    ...
    },
    {
      ...
      "outputQty": 1,
      "materials": "木料*6、铁*3、绳子*2、武器零件*3",
      "tools": "卡尺",
      "craftLocation": "工作台（卡尺）",
      "books": "《机械之美》",
      "workMinutes": 480,
    ...
    },
    {
      ...
      "books": "",
      "workMinutes": 30,
      "crafterGate": "营地里还没有宰杀设施（已有就不能再造）",
      "_id": "butcher_point",
    ...
    },
    {
      ...
      "books": "",
      "workMinutes": 60,
      "crafterGate": "营地里已有简易宰杀点（升级成宰杀台的前提）",
      "_id": "butcher_table",
    ...
    },
    {
      ...
      "productType": "武器",
      "group": "武器",
      "output": "repair_sniper_rifle",
      "outputQty": 1,
      "materials": "损坏的狙击枪*1、武器零件*3",
      "tools": "卡尺",
      "craftLocation": "工作台（卡尺）",
      "books": "《枪械维修指南》",
      "workMinutes": 240,
      "crafterGate": "",
      "_id": "repair_sniper_rifle",
      "_configId": "repair_sniper_rifle",
      "_crafterGateIds": "",
      "_anchor": "godot/scripts/Recipe.cs :: RecipeBook（Id = \"repair_sniper_rifle\"）",
      "description": "",
      "userNote": "",
      "sync": "",
      "_icon": "weapons/sniper_rifle"
  ...
  "columns": [
    ...
    },
    {
      ...
      "label": "消耗类型",
      "type": "chip",
      "hint": "固定光源无限；手电吃电池；火把按燃烧耐久耗尽。"
    },
    {
      "key": "activeSeconds",
      "label": "可用时长(游戏秒)",
      "type": "number",
      "hint": "手持光源从满格到耗尽的游戏秒；固定光源为 0（无限）。"
    },
    {
      "key": "description",
      "label": "简介",
  ...
  "rows": [
    {
      "title": "野外生存指南",
      "readHours": 4,
      "unlocks": "解锁配方：骨刀、短弓、削尖的木箭、圈套陷阱、战争面具、恐怖装甲；被动：不使用任何手术材料时，手术加成点数 +3（教的是没器械时的土办法；一旦投了正规耗材就不加）",
    ...
    },
    {
      "title": "裁缝手记",
      "readHours": 8,
      "unlocks": "解锁配方：粗布背心、布夹克、粗布衬衫、棉帽、粗布短裤、粗布长裤",
    ...
    },
    {
      "title": "尖峰时刻",
      "readHours": 6,
      "unlocks": "解锁配方：自制简易墨镜、护踝鞋具；被动：骨折恢复速度 +15%",
    ...
    },
    {
      "title": "尖峰时刻·三",
      "readHours": 6,
      "unlocks": "解锁配方：雪地靴；被动：认得葛根和大黄，可在野外交互采集",
  ...
  "rows": [
    ...
    },
    {
      ...
      "part": "枪管",
      "stats": "最大射程 *0.8、衰减起点 *0.8、穿透 *0.85、基础散布 *1.25、伤害下限 *0.9、伤害上限 *0.9、重量 *0.8、允许单手持有",
      "form": "",
      "materials": "",
      "workMinutes": 60,
    ...
    },
    {
      ...
      "fitsWeapons": "自制猎枪、手枪、冲锋枪、步枪、狙击枪、自制霰弹枪",
      "part": "枪管",
      "stats": "最大射程 *1.2、衰减起点 *1.2、基础散布 *0.8、攻击间隔 *1.1、穿透 *1.1、重量 *1.35",
      "form": "",
      "materials": "铁*3",
      "workMinutes": 240,
    ...
    },
    {
      ...
      "part": "枪口",
      "stats": "枪托伤害下限 =1.5、枪托伤害上限 =7、枪托穿透 =0.24、枪托间隔 =2、枪托噪音半径 =95、基础散布 *1.03、重量 *1.1",
      "form": "刺刀型",
      "materials": "铁*4、绳子*1",
      "workMinutes": 240,
    ...
    },
    {
      ...
      "fitsWeapons": "自制猎枪、步枪、狙击枪、自制霰弹枪",
      "part": "枪托",
      "stats": "枪托伤害下限 =6.6、枪托伤害上限 =13.3、枪托穿透 =0.166、枪托间隔 =3.8824、枪托噪音半径 =125、基础散布 *1.1、重量 *1.3",
      "form": "利爪型",
    ...
    },
    {
      ...
      "fitsWeapons": "自制猎枪、步枪、狙击枪、自制霰弹枪",
      "part": "枪托",
      "stats": "枪托伤害下限 =6、枪托伤害上限 =14、枪托穿透 =0.05、枪托间隔 =4.2353、枪托噪音半径 =130、基础散布 *0.97、重量 *1.5",
      "form": "创伤型",
      "materials": "铁*4",
      "workMinutes": 240,
    ...
    },
    {
      ...
      "fitsWeapons": "手枪、冲锋枪",
      "part": "枪托",
      "stats": "枪托伤害下限 =1、枪托伤害上限 =4.75、枪托穿透 =0.075、枪托间隔 =1.6471、枪托噪音半径 =90、重量 *1.05",
      "form": "锋刃型",
      "materials": "铁*1、绳子*1",
      "workMinutes": 90,
    ...
    },
    {
      ...
      "part": "刃",
      "stats": "穿透 *0.8、BleedRateMultiplier *1.4",
      "form": "",
      "materials": "",
      "workMinutes": 240,
    ...
    },
    {
      ...
      "fitsWeapons": "匕首、短剑、长剑、草叉、重剑",
      "part": "刃",
      "stats": "攻击间隔 *0.85、伤害下限 *0.9、伤害上限 *0.9、重量 *0.75",
      "form": "",
      "materials": "铁*1",
      "workMinutes": 240,
    ...
    },
    {
      ...
      "part": "剑柄",
      "stats": "伤害下限 *1.06、伤害上限 *1.06、重量 *1.18",
      "form": "",
      "materials": "铁*1",
      "workMinutes": 120,
    ...
    {
      "name": "防滑缠手",
      "fitsWeapons": "匕首、短剑、刺剑、长剑、草叉、重剑、棍棒、尖头锤、破甲锤、消防斧、骨刀",
      "part": "缠手",
      "stats": "攻击间隔 *0.95",
      "form": "",
      "materials": "绳子*1",
    ...
    },
    {
      ...
      "fitsWeapons": "棍棒",
      "part": "棍棒上部",
      "stats": "伤害下限 *1.15、伤害上限 *1.15、重量 *1.12",
      "form": "",
      "materials": "铁丝*2",
      "workMinutes": 60,
    ...
    },
    {
      ...
      "fitsWeapons": "棍棒",
      "part": "棍棒顶端",
      "stats": "穿透 +0.03、BleedOnHitChance =0.25",
      "form": "",
      "materials": "钉子*4",
      "workMinutes": 60,
    ...
    },
    {
      ...
      "fitsWeapons": "短弓、长弓",
      "part": "弓",
      "stats": "攻击间隔 *1.06、伤害下限 *1.08、伤害上限 *1.08、穿透 *1.08、FlightSpeed *1.12、重量 *1.15",
      "form": "",
      "materials": "木料*2、胶水*2",
      "workMinutes": 180,
    ...
    },
    {
      ...
      "part": "弦",
      "stats": "攻击间隔 *1.06、伤害下限 *1.04、伤害上限 *1.04、基础散布 *0.92、FlightSpeed *1.12、最远伤害系数 *1.18",
      "form": "",
      "materials": "绳子*2",
      "workMinutes": 90,
      "note": "当心手指。",
  ...
  "rows": [
    ...
    },
    {
      ...
      "materials": "木料*8、布*6、钉子*4",
      "buildMinutes": 240,
      "salvage": "木料*2、废木料*2、布*3、钉子*2",
      "description": "木椅的升级版。坐上去读书快一点，恢复也快一点——代价是它占地方，也吃掉更多布料。",
      "_id": "沙发",
      "_configId": "沙发",
      "_anchor": "godot/scripts/FurnitureBuildCost.cs :: FurnitureBuildCost",
      "userNote": "",
  ...
  "rows": [
    ...
    },
    {
      ...
      "value": 50,
      "unit": "%",
      "note": "每颗成熟收获时掷一次点：这个几率出 2 颗（最常见的一档）。三档几率相加 = 100%。",
      "_id": "crop_yield_out2",
      "_anchor": "godot/scripts/Farming.cs :: CropPlotLogic.Out2Chance",
      "_icon": "",
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      ...
      "value": 25,
      "unit": "%",
      "note": "走运的一档：这个几率出 3 颗。",
      "_id": "crop_yield_out3",
      "_anchor": "godot/scripts/Farming.cs :: CropPlotLogic.Out3Chance",
      "_icon": "",
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      ...
      "value": 25,
      "unit": "%",
      "note": "下限档：这个几率只出 1 颗（= 种薯成本 1 ⇒ 回本，永不亏种子）。",
      "_id": "crop_yield_out1",
      "_anchor": "godot/scripts/Farming.cs :: CropPlotLogic.Out1Chance",
      "_icon": "",
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      ...
      "value": 2,
      "unit": "颗",
      "note": "按上面三档几率算的每颗平均收成（下种消耗 1 ⇒ 净赚约 1 颗/颗）。",
      "_id": "crop_expected_yield",
      "_anchor": "godot/scripts/Farming.cs :: CropPlotLogic.ExpectedYieldPerPlant",
      "_icon": "",
      "description": "",
      "userNote": "",
      "sync": ""
  ...
  "rows": [
    ...
    },
    {
      ...
      "value": 7,
      "unit": "%",
      "note": "同一只手每少一根手指累加这么多折扣（缺两指的山姆＝0.86）。",
  ...
  "rows": [
    {
      ...
      "perkL1": "入队即得。山姆从小在农场帮奶奶干活，负重+15%，操作能力+10%。",
      "perkL2": "营地 3 人。他从小身强体壮、性格坚韧，比常人耐揍——自身受到的伤害 −10%（在护甲挡完之后再减，被甲完全挡下时依然是 0）。并且山姆的恢复速度*1.3。",
      "perkL3": "营地 6 人。山姆将英雄气概与坚韧不拔展示的淋漓尽致，山姆的受到的所有大流血降级为中流血，被震荡的概率-75%，受到骨折的负面影响-30%。",
      "join": "开局就在营地（另一位是诺蒂）。",
    ...
    },
    {
      ...
      "perkL2": "累计读满 24 小时。自身阅读速度加成变为75%。",
      "perkL3": "累计读满 72小时。自身阅读速度加成为 75%，且全营所有人阅读速度 +25%（含他自己 ⇒ 他自己合计 +100%）。",
      "join": "开局就在营地（另一位是山姆）。",
      "gear": "开局三件套（长袖布衣 / 长裤 / 一双运动鞋）",
    ...
    },
    {
      ...
      "perkL2": "共同活过 5 天。布鲁斯视野距离 +10%；解锁道格给布鲁斯做狗装备（五件套）。布鲁斯的攻击速度和移动速度都+12%。",
      "perkL3": "共同活过 12 天。相依为命光环（两个在 160 距离内时生效）：操作能力*1.25、受到伤害 *0.85。一方死亡即永久失去。",
    ...
    },
    {
      ...
      "perkL2": "她做满 3 台手术。卫生意识让床铺更干净——全营感染率 −15%（要她在营活着才维持，不在营/死了就失效）。并且干净的床铺让睡在上面的人恢复速度加成从10%变到20%。",
    ...
    },
    {
      ...
      "notes": "专属效果数值为用户拍板值；L1 与 L3 的不掉饥饿概率是同一专属效果内的加算例外，合计 35%。买入折扣和卖出价率都要求她仍在营存活。反水阈值：任一劫掠者血量掉到 50% 以下，或她自己掉血（满血即触发）。",
      "draft": true,
      "_id": "christine",
    ...
    },
    {
      ...
      "perkName": "疾行如风",
      "perkAxis": "两条不同形态的轴（升级不倒退）：\n· L1→L2「连续饿着」：相位级查——每相位饥饿 ≥3 连续计数 +1，任一相位 小于 3 清零重记；连续 10 相位（= 5 天·每天 2 相位）不断 → 永久升 L2（latch，此后再饿一顿也不掉回去）。\n· L2→L3「饿着还出门」：出发瞬间饥饿 ≤5 计一次（单调累计只增不减），累计 3 次 → L3。",
      "perkL1": "入队即得。移速 1.15 倍。\n且不论几级都常驻：大男孩代谢快，每相位 25% 概率额外掉 1 饥饿（合计一相位掉 2）。",
      "perkL2": "连续 5 天饥饿 ≥3。移速升到 1.25 倍；操作能力 *1.05（+5%，与残疾、饥饿、骨折及其他来源乘算）。",
      "perkL3": "达 L2 后饥饿 ≤5 出发累计 3 次。移速升到 1.3 倍；保留 2 级操作加成；负重小于 30kg 时，受击有 15% 概率闪避（整次攻击无效，背太重就闪不动）。",
      "join": "第 7 天夜一开局，一个男孩跑到大门外拍门大喊求救，弹三选一：开门救援 / 置之不理 / 攻击他。\n· 开门救援 → 追在他身后的三只普通丧尸（非精英）一起涌到门口；三尸全歼且男孩存活 → 他作为「皮特」入营；男孩战死 → 救援失败（不入营）。\n· 置之不理 / 攻击他 → 男孩死亡、事件结束（整条招募不再触发）。",
      "gear": "开局三件套",
      ...
      "notes": "数值口径：效果值（移速/操作/闪避/饥饿）是用户拍板·非拟定；升级阈值（连续相位/出行次数）是拟定待调。专属效果名「田径队大男孩」取自代码注释的 authored 描述，非正式命名，待你定。数字在隔壁「角色数值」分区。",
      "draft": true,
      "_id": "pete",
    ...
    },
    {
      ...
      "perkL1": "入队即得。脚步和动作（脚步 / 开门 / 撬锁 / 静默拆除）噪音 *0.6（减 40%）——战斗、开枪、破坏这些不减；翻找搜刮速度 +50%。",
      "perkL2": "累计搜出 75 件。翻找搜刮速度再 +100%（合计 +150% ⇒ 2.5 倍）；并且她翻找东西不会产生任何噪音。",
      "perkL3": "累计搜出 250 件。黑暗带来的隐匿点 +50%；破隐先手攻击额外再造成 +35% 伤害。黑暗隐匿、服装、负重、掩体四项会共同影响被发现距离；未被敌方感知时的第一次攻击获得破隐先手加成。",
      ...
      "notes": "数值为用户原话·非拟定（75/250 件、−40% 噪音、+50% 搜刮、再 +100%）。L2 搜刮速度 2.50 倍 是用户明确指定的**加算例外**（同一 perk 自己的两级台阶按总量口述），不是漏网的加算残留，别顺手改成乘算。数字在隔壁「角色数值」分区。",
      "draft": true,
      "_id": "rat",
  ...
  "rows": [
    ...
    },
    {
      ...
      "unit": "%",
      "settled": true,
      "_id": "sam_l1_operation_bonus",
      "_anchor": "godot/scripts/SurvivorPerks.cs :: SamPerk.Level1OperationBonus",
      "_icon": "",
      "_configId": "SamLevel1OperationBonus",
      "_configPercent": true,
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      ...
      "unit": "%",
      "settled": true,
      "_id": "sam_l2_heal_speed",
      "_anchor": "godot/scripts/SurvivorPerks.cs :: SamPerk.Level2HealSpeedBonus",
      "_icon": "",
      "_configId": "SamLevel2HealSpeedBonus",
      "_configPercent": true,
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      ...
      "unit": "%",
      "settled": true,
      "_id": "sam_l3_concussion_reduction",
      "_anchor": "godot/scripts/SurvivorPerks.cs :: SamPerk.Level3ConcussionReduction",
      "_icon": "",
      "_configId": "SamLevel3ConcussionReduction",
      "_configPercent": true,
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      ...
      "unit": "%",
      "settled": true,
      "_id": "sam_l3_fracture_penalty_reduction",
      "_anchor": "godot/scripts/SurvivorPerks.cs :: SamPerk.Level3FracturePenaltyReduction",
      "_icon": "",
      "_configId": "SamLevel3FracturePenaltyReduction",
      "_configPercent": true,
      "description": "",
      "userNote": "",
      "sync": ""
    ...
    },
    {
      ...
      "unit": "%",
      "settled": false,
      "_id": "bond_aura_operation",
      "_anchor": "godot/scripts/DougBruceBond.cs :: DougBruceBond.AuraOperationMult",
      "_icon": "",
      "description": "",
      "userNote": "",
      "sync": ""
    ...
    },
    {
      ...
      "unit": "%",
      "settled": false,
      "_id": "bruce_attack_speed",
      "_anchor": "godot/scripts/DougBruceBond.cs :: DougBruceBond.BruceAttackSpeedMult",
      "_icon": "",
      "description": "",
      "userNote": "",
      "sync": ""
    ...
    {
      "group": "生存",
      "label": "2 级 干净床铺恢复速度加成",
      "who": "南丁格尔",
      "value": 20,
      "unit": "%",
      "settled": true,
      "_id": "nurse_l2_bed_heal",
      "_anchor": "godot/scripts/SurvivorPerks.cs :: NightingalePerk.Level2BedSleepHealBonusPct",
      "_icon": "",
      "_configId": "NightingaleBedSleepHealBonusPct",
      "description": "",
      "userNote": "",
      "sync": ""
    },
    ...
    },
    {
      ...
      "unit": "天",
      "settled": false,
      "_id": "christine_l2_days",
      "_anchor": "godot/scripts/ChristinePerk.cs :: ChristinePerk.Level2ThresholdDays",
      "_icon": "",
      "_configId": "ChristineLevel2ThresholdDays",
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      ...
      "unit": "%",
      "settled": true,
      "_id": "christine_l1_hunger_skip",
      "_anchor": "godot/scripts/ChristinePerk.cs :: ChristinePerk.L1HungerSkipChance",
      "_icon": "",
      "_configId": "ChristineL1HungerSkipChance",
      "_configPercent": true,
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      ...
      "unit": "%",
      "settled": true,
      "_id": "christine_l2_buy_discount",
      "_anchor": "godot/scripts/ChristinePerk.cs :: ChristinePerk.Level2BuyDiscount",
      "_icon": "",
      "_configId": "ChristineLevel2BuyDiscount",
      "_configPercent": true,
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      ...
      "unit": "%",
      "settled": true,
      "_id": "christine_l3_hunger_skip",
      "_anchor": "godot/scripts/ChristinePerk.cs :: ChristinePerk.L3ExtraHungerSkipChance",
      "_icon": "",
      "_configId": "ChristineL3ExtraHungerSkipChance",
      "_configPercent": true,
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      ...
      "unit": "%",
      "settled": true,
      "_id": "christine_l3_sell_rate",
      "_anchor": "godot/scripts/ChristinePerk.cs :: ChristinePerk.Level3SellRatePercent",
      "_icon": "",
      "_configId": "ChristineLevel3SellRatePercent",
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      ...
      "unit": "倍",
      "settled": true,
      "_id": "pete_l1_movespeed",
      "_anchor": "godot/scripts/PetePerk.cs :: PetePerk.Level1MoveSpeedMultiplier",
      "_icon": "",
      "_configId": "PeteLevel1MoveSpeedMultiplier",
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      ...
      "unit": "倍",
      "settled": true,
      "_id": "pete_l2_movespeed",
      "_anchor": "godot/scripts/PetePerk.cs :: PetePerk.Level2MoveSpeedMultiplier",
      "_icon": "",
      "_configId": "PeteLevel2MoveSpeedMultiplier",
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      ...
      "unit": "倍",
      "settled": true,
      "_id": "pete_l3_movespeed",
      "_anchor": "godot/scripts/PetePerk.cs :: PetePerk.Level3MoveSpeedMultiplier",
      "_icon": "",
      "_configId": "PeteLevel3MoveSpeedMultiplier",
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      ...
      "unit": "%",
      "settled": true,
      "_id": "pete_l2_operation",
      "_anchor": "godot/scripts/PetePerk.cs :: PetePerk.OperationCapabilityBonus",
      "_icon": "",
      "_configId": "PeteOperationCapabilityBonus",
      "_configPercent": true,
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      ...
      "settled": true,
      "_id": "pete_l3_dodge",
      "_anchor": "godot/scripts/PetePerk.cs :: PetePerk.DodgeChanceValue",
      "_icon": "",
      "_configId": "PeteDodgeChanceValue",
      "_configPercent": true,
      "description": "",
      "userNote": "",
      "sync": ""
    ...
    {
      "group": "战斗",
      "label": "3 级 闪避的负重上限（严格小于才可闪）",
      "who": "皮特",
      "value": 30,
      "unit": "公斤",
      "settled": true,
      "_id": "pete_l3_dodge_maxkg",
      "_anchor": "godot/scripts/PetePerk.cs :: PetePerk.DodgeMaxCarriedKg",
      "_icon": "",
      "_configId": "PeteDodgeMaxCarriedKg",
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      "group": "生存",
      "label": "额外掉 2 饥饿的概率（1 级起常驻）",
      "who": "皮特",
      "value": 25,
      "unit": "%",
      "settled": true,
      "_id": "pete_extra_hunger",
      "_anchor": "godot/scripts/PetePerk.cs :: PetePerk.ExtraHungerDropChance",
      "_icon": "",
      "_configId": "PeteExtraHungerDropChance",
      "_configPercent": true,
      "description": "",
      "userNote": "",
      "sync": ""
    ...
    {
      "group": "升级门槛",
      "label": "连续计数的饥饿下限（≥它才续连续）",
      "who": "皮特",
      "value": 3,
      "unit": "饥饿值",
      "settled": false,
      "_id": "pete_hunger_streak_floor",
      "_anchor": "godot/scripts/PetePerk.cs :: PetePerk.HungerThresholdForStreak",
      "_icon": "",
      "_configId": "PeteHungerThresholdForStreak",
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      "group": "升级门槛",
      "label": "升 2 级 所需连续相位（= 5 天·每天 2 相位）",
      "who": "皮特",
      "value": 10,
      "unit": "相位",
      "settled": false,
      "_id": "pete_l2_phases",
      "_anchor": "godot/scripts/PetePerk.cs :: PetePerk.Level2ConsecutivePhases",
      "_icon": "",
      "_configId": "PeteLevel2ConsecutivePhases",
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      "group": "升级门槛",
      "label": "升 3 级 出行计数的饥饿上限",
      "who": "皮特",
      "value": 5,
      "unit": "饥饿值",
      "settled": false,
      "_id": "pete_l3_departure_ceiling",
      "_anchor": "godot/scripts/PetePerk.cs :: PetePerk.DepartureHungerCeiling",
      "_icon": "",
      "_configId": "PeteDepartureHungerCeiling",
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      "group": "升级门槛",
      "label": "升 3 级 所需合格出行次数",
      "who": "皮特",
      "value": 3,
      "unit": "次",
      "settled": false,
      "_id": "pete_l3_departures",
      "_anchor": "godot/scripts/PetePerk.cs :: PetePerk.Level3DepartureCount",
      "_icon": "",
      "_configId": "PeteLevel3DepartureCount",
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      ...
      "settled": true,
      "_id": "rat_l2_items",
      "_anchor": "godot/scripts/SurvivorPerks.cs :: RatPerk.Level2ThresholdItems",
      "_icon": "",
      "_configId": "RatLevel2ThresholdItems",
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      ...
      "settled": true,
      "_id": "rat_l3_items",
      "_anchor": "godot/scripts/SurvivorPerks.cs :: RatPerk.Level3ThresholdItems",
      "_icon": "",
      "_configId": "RatLevel3ThresholdItems",
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      "group": "感知",
      "label": "1 级 动作噪音半径乘子（脚步/开门/撬锁/拆除）",
      "who": "耗子",
      "value": 0.6,
      "unit": "倍",
      "settled": true,
      "_id": "rat_l1_noise",
      "_anchor": "godot/scripts/SurvivorPerks.cs :: RatPerk.Level1ActionNoiseMultiplier",
      "_icon": "",
      "_configId": "RatLevel1ActionNoiseMultiplier",
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      ...
      "settled": true,
      "_id": "rat_l1_loot",
      "_anchor": "godot/scripts/SurvivorPerks.cs :: RatPerk.Level1LootSpeedBonus",
      "_icon": "",
      "_configId": "RatLevel1LootSpeedBonus",
      "_configPercent": true,
      "description": "",
      "userNote": "",
      "sync": ""
    ...
    {
      "group": "操作与生产",
      "label": "2 级 翻找搜刮速度再加成（指定加算例外）",
      "who": "耗子",
      "value": 100,
      "unit": "%",
      "settled": true,
      "_id": "rat_l2_loot",
      "_anchor": "godot/scripts/SurvivorPerks.cs :: RatPerk.Level2LootSpeedBonus",
      "_icon": "",
      "_configId": "RatLevel2LootSpeedBonus",
      "_configPercent": true,
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      ...
      "settled": true,
      "_id": "rat_l3_darkness",
      "_anchor": "godot/scripts/SurvivorPerks.cs :: RatPerk.Level3DarknessStealthBonus",
      "_icon": "",
      "_configId": "RatLevel3DarknessStealthBonus",
      "_configPercent": true,
      "description": "",
      "userNote": "",
      "sync": ""
    },
    {
      ...
      "settled": true,
      "_id": "rat_l3_ambush",
      "_anchor": "godot/scripts/SurvivorPerks.cs :: RatPerk.Level3AmbushDamageBonus",
      "_icon": "",
      "_configId": "RatLevel3AmbushDamageBonus",
      "_configPercent": true,
      "description": "",
      "userNote": "",
      "sync": ""
  ...
  "columns": [
    ...
    },
    {
      ...
      "label": "种类",
      "type": "chip",
      "hint": "好结局 WIN / 坏结局 / 失败路由（把玩家推向坏结局的中间态，本身非终局）。"
    },
    {
      "key": "trigger",
      "label": "触发条件",
  ...
  "rows": [
    {
      "name": "举家南逃（好结局 WIN）",
      "kind": "好结局 WIN",
      "trigger": "联系南方 → 南境审判三问全部答满、总分达到通过线 → 回营电台确认启程 → 全营列队南逃 → 抵达峡谷前，对方大桥**落下**、有人迎接，全员过桥无一落下 → 过渡到第二幕「峡谷营地」（很久远排期）。（通过所需票数见「全局规则·南境审判」。）",
    ...
    },
    {
      "name": "南方失败（失败路由·非终局）",
      "kind": "失败路由",
      "trigger": "南境审判三问总分未达通过线 → 不通过 → 解锁「回复军方」选项 → 最终落进军袭或第 40 天坏结局。**本身不是结局**，是把玩家推向坏结局的路由态。",
      "cg": "无独立 CG（路由态·非终局）。后续 CG 走军袭 / 第 40 天坏结局。",
      "_id": "south-trial-failure",
      "_anchor": "godot/scripts/SouthTrial.cs（未过）→ RadioMainline.ReopenAfterSouthFailure（解锁回复军方）",
      "_icon": "",
      "description": "",
      "userNote": "",
      "sync": ""
