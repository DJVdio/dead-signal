...
window.WIKI_BUNDLE = {
  ...
  "rows": [
    ...
    },
    {
      ...
      "perkL2": "连续 5 天饥饿 ≥3。移速升到 1.25 倍；操作能力 *1.05（+5%，乘算不截断——没有手的人 0*1.05 还是 0）。",
      "perkL3": "达 L2 后饥饿 ≤5 出发累计 3 次。移速升到 1.3 倍；负重 小于 30kg 时受击 15% 概率闪避（整次攻击无效，背太重就闪不动）。累进保留下级。",
