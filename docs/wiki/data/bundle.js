...
window.WIKI_BUNDLE = {
  ...
  "rows": [
    {
      "title": "野外生存指南",
      "readHours": 4,
      "unlocks": "解锁制作骨刀、短弓、削尖木箭、圈套陷阱、战争面具、恐怖装甲，不使用任何手术材料时手术加成点数+3。角色认识地上的土豆和蘑菇，能够交互采集。",
  ...
  "rows": [
    ...
    },
    {
      ...
      "description": "男人对于粗俗的东西，总是秉持着一个简单的道理——长就是好。",
      "userNote": "",
      "sync": "",
  ...
  "rows": [
    ...
    },
    {
      ...
      "value": 5,
      "unit": "分",
      "note": "南境审判三问各计 0/1/2 分（满分 6），三题总分凑够这么多才算过。",
  ...
  "rows": [
    ...
    },
    {
      ...
      "perkL2": "连续 5 天饥饿 ≥3。移速升到 1.2 倍；他的动作快到能躲子弹，被攻击击中时，有15%的几率判定为闪避使该次攻击失效。",
  ...
  "rows": [
    ...
    },
    {
      ...
      "_configPercent": true,
      "description": "上肢操作、下肢移动两种骨折惩罚的负面缺口减轻 30%。",
      "userNote": "",
      "sync": ""
    },
    {
