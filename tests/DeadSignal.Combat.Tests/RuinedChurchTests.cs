...
public class RuinedChurchTests
{
    ...
    /// <para>
    /// 而 <c>docs/research/2026-07-14-lanchester.md</c>（机器生成·**2026-07-17 全仓重跑值**）：
    /// 1 只＝100%，2 只＝84.5%，3 只＝<b>22.0%</b>，4 只＝<b>1.6%</b>，5 只起＝<b>0%</b>
    /// ⇒ 墓地这 <b>12 只</b>远在断崖之下 ⇒ <b>你唤醒的不是一场仗，是一个必须立刻离开的房间。</b>
    /// <br/>（此前这里写的"2 只 16.6%、3 只 0.8%"是陈旧数：那组出自 [T53] 已被用户否决并回退掉的
    /// <b>70/1.5 热流血口径</b>，当前代码 <c>BleedModel.DefaultBleedRatePerWound = 0.55</c> 下复现不出来。）
    /// </para>
    /// <para>
