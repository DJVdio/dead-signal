...
/// <summary>
/// 描述性战斗日志生成器（<see cref="CombatLogFormatter"/>）。承伤方视角、纯函数。
/// 措辞口径：钝=砸伤、锐=撕裂；被甲挡下走"挡下"专述；断肢/骨折/脑震荡/流血依序追加；
/// 致死追加专门措辞（"毙命"）。
/// </summary>
public class CombatLogFormatterTests
{
    ...
    [Fact]
    public void Line_ContainsTargetName_PartName_AndDamageNumber()
    {
        string line = CombatLogFormatter.Format("阿强", Hit(9, "左小腿", DamageType.Sharp));
    ...
    {
        string line = CombatLogFormatter.Format("阿强", Hit(7, "头部", DamageType.Blunt));
    ...
    {
        string line = CombatLogFormatter.Format("阿强", Hit(7, "头部", DamageType.Sharp));
    ...
    {
        string line = CombatLogFormatter.Format("阿强", Hit(0, "胸部", DamageType.Sharp, blocked: true));
    ...
    {
        string line = CombatLogFormatter.Format("阿强", Hit(20, "右手", DamageType.Sharp, severed: true));
    ...
    {
        string line = CombatLogFormatter.Format("阿强", Hit(12, "左臂", DamageType.Blunt, fractured: true));
    ...
    {
        string line = CombatLogFormatter.Format("阿强", Hit(8, "头部", DamageType.Blunt, concussed: true));
    ...
    {
        string line = CombatLogFormatter.Format("阿强", Hit(6, "颈部", DamageType.Sharp, bled: true));
    ...
    {
        string line = CombatLogFormatter.Format("阿强", Hit(40, "头部", DamageType.Sharp, died: true));
    ...
    {
        string line = CombatLogFormatter.Format("阿强",
    ...
    {
        string line = CombatLogFormatter.Format("阿强", Hit(40, "头部", DamageType.Blunt,
    ...
    [Fact]
    public void EmptyName_FallsBackToPlaceholder_NoLeadingSpaceOnly()
    {
        string line = CombatLogFormatter.Format("", Hit(5, "腹部", DamageType.Blunt));
