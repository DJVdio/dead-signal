...
public static class GoldfingerGang
{
    ...
    // ── 伤情三档（拟定待调）────────────────────────────────────────────────
    // 参考量级：胸 MaxHp 20 / 腹 16 / 头 16 / 上臂 21 / 大腿 12（HumanBody）。致死池 = 胸+腹+头。
    ...
    /// 起因是这一关被重排到<b>中期</b>（金手指帮不再是终局），而实测告诉我们原案在中期是这样的：
    /// <list type="bullet">
    /// <item>中期玩家（3 人同持<b>消防斧</b>）潜行清哨<b>胜率 92.6%</b> —— 看着"可行"，
    /// 但<b>全身而退只有 2%、平均留下 3.26 处永久残缺</b>：**赢了，全队残废**。那不叫可行。</item>
    /// <item>撤掉两把手枪之后：<b>99.8% / 全身而退 12% / 2.04 处残缺</b> —— 赢了，有人挂彩。<b>这才叫可行。</b></item>
    /// <item><b>正面仍然很贵</b>：逐波推进 46.7%，但<b>平均阵亡 1.43 / 3 人</b>、惨胜 99%——抛硬币赔掉半个队。</item>
    /// <item>🔴 <b>红线守住了</b>：「惊动全据点」<b>仍然是 0%</b>。<b>枪一响还是死。</b>
    /// 降难度<b>没有</b>把这关变成无脑清场，噪音设计（弓/匕首叫醒 0 人、手枪 2 人、步枪 5 人）<b>一格没动</b>。</item>
    /// </list>
