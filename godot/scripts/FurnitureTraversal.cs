...
/// <summary>
/// <b>家具可跨越 + 跨过减速</b> —— 用户拍板「<b>椅子之类的别的家具都可以跨过，但是跨过时会减少 25% 的移动速度</b>」
...
{
    /// <summary>
    /// 跨过一件可跨越家具时的<b>移速乘子</b>（−25%，拟定待调）。
    /// <b>乘算</b>进 <c>Actor</c> 的既有移速链，<b>不是</b>从总数里减 25 个百分点（见类注）。
    /// </summary>
