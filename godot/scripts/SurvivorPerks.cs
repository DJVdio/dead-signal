...
/// **含 L3 书虫本人**（故蒂诺 L3 有座 = 1+0.50+0.25 = ×1.75；普通人在其营地有座 = 1+0+0.25 = ×1.25）。座位惩罚为 draft。
/// </summary>
