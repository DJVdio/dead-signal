...
///
/// <para>═══ ⚠️ <b>「鸽子/干豆保持能吃、不删」那条裁决：一半更硬了，一半被用户自己撤了</b>（本轮记一句）═══
/// 今天早些时候的裁决是"鸽子/干豆<b>保持能吃</b>、不删"，理由是**它们没有第二条命**（只是热量点而已，删了就成死物品）。
/// 本轮用户的改动把这条裁决<b>劈成了两半</b>：
/// <list type="bullet">
/// <item>🔴 <b>「不删」这一半：更站得住了。</b> 鸟（原鸽子）现在有了**第二条命**——它是<b>整条弓箭线的原料源头</b>
///       （陷阱 → 鸟 → 宰杀 → 羽毛 → 三种箭）。⇒ 那条"别删"从<b>宽容</b>变成了<b>必需</b>：删掉鸟＝掐断弓箭线。</item>
/// <item>⚠️ <b>「保持能吃」这一半：被用户亲手撤销了。</b> 用户原话「**老鼠和鸟不能直接入锅了**」
///       ⇒ 它们已从 <see cref="FoodCalories"/> 移除。<b>不是我引申的，是规格改了。</b>
///       （干豆没被点名 ⇒ <b>干豆仍可直接吃</b>，一个字没动。）</item>
/// </list></para>
///
