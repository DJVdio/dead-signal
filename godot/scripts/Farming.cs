...
/// 用户后来几经增/减改成了<b>三段分布</b>；<b>唯一真源＝<see cref="CropPlotLogic.Out2Chance"/> 一族</b>
/// （见 <see cref="CropPlotLogic"/> 里那条"用户最终拍板"注）。本类注只讲形态、不复制档位数字——
/// 此前正是这段抄了旧档位，与代码差了整整一倍还没人发现。</para>
///
