...
/// </para>
/// <para>
/// ⚠️ <b>只搬数值、不搬 authored 结构</b>：本段只装 <see cref="NightWatchContest"/> 的<b>潜行力权重标量</b>
/// （原 5 个 <c>public const float</c>）。<c>ApparelStealth</c> 那张<b>逐件带风味注释的服饰潜行表是 authored 内容</b>，
