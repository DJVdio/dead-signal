...
//
// 🔴 **推开门 = 转身就跑，不是清场。**（docs/research/2026-07-14-lanchester.md·**2026-07-17 全仓重跑值**）
//    1 只＝100%，2 只＝84.5%，**3 只＝22.0%**，4 只＝1.6%，5 只起＝**0%**。围攻是**断崖不是斜坡**——断崖在 2→3 之间。
//    12 只 ⇒ 站着打＝必死（5 只就已经是 0%，12 只连讨论的余地都没有）。**设计意图就是让你转身跑，并把门关上。**
...
public static class RuinedChurch
{
    ...
    /// <para>
    /// **这 12 只不是让你清完的。** 2 只围攻＝84.5%（且要付 1.14 处永久残缺），**3 只＝22.0%**，4 只＝1.6%，5 只起＝0%
    /// （docs/research/2026-07-14-lanchester.md·**2026-07-17 全仓重跑值**）。**设计意图是让你转身跑，并把门关上。**
    /// </para>
    /// </summary>
    /// <remarks>
