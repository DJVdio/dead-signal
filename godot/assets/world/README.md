...
- 规格：每张 1536×1024 RGBA；12 列依次为站立、三帧步行、攻击蓄势/出手、受击、工作、站读、坐读、坐姿、卧姿。生成器稳定输出 7 个方向行，东南暂复用东向行；方向补帧待实机验收后人工精修。
- 来源：OpenAI 内置 image generation，2026-07-20 以既有正式站立图集作身份参考生成；项目原创资产。
- 后处理：`#ff00ff` 色键去底，soft matte + despill；全部验证为 1536×1024 RGBA。
