...
- 规格：每张 896×1176 RGBA，精确 7×8 网格，单格 128×147；7 列依次为单手挥砍、单手戳刺、单手射击、双手挥砍、双手戳刺、双手射击、双手拉弓射箭，8 行依次为南、西南、西、西北、北、东北、东、东南。
- 来源：OpenAI 内置 image generation，2026-07-21 以既有角色身份和服装为参考生成；项目原创资产。生成模式为内置图像生成。
- 后处理：`#ff00ff` 色键经官方 chroma helper 以 soft matte + despill 去底；保留模型稳定输出的南/西南/西/西北/北五个原生方向，东北/东/东南分别由西北/西/西南确定性水平镜像补齐，再逐格最近邻整理到标准尺寸。密集 14×8 首稿和大头诺蒂首稿均未采用。
